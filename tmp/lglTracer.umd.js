...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : t(
        ((e =
          "undefined" != typeof globalThis ? globalThis : e || self).LGLTracer =
          {}),
        e.THREE
      );
})(this, function (e, t) {
  ...
  function i(e, t) {
    const a = {};
    for (const n of t) a[n] = e.getExtension(n);
    return a;
  }
  function o(e, t) {
    const a = {},
    ...
    for (let i = 0; i < n; i++) {
      const { name: n } = e.getActiveAttrib(t, i);
      n && (a[n] = e.getAttribLocation(t, n));
    }
    return a;
  }
  const r = ["EXT_color_buffer_float", "EXT_float_blend"],
    s = ["OES_texture_float_linear"];
  function l(e, { color: t, depth: a }) {
    ...
    return (
      (function () {
        ...
        const n = [];
        for (let a in t) {
          (a = Number(a)), void 0 === a && console.error("invalid location");
          const i = t[a];
  ...
  let d;
  function c(e, t) {
    return { values: `uniform${e}${t}`, array: `uniform${e}${t}v` };
  }
  function u(e, t) {
    return {
      matrix: e === t ? `uniformMatrix${e}fv` : `uniformMatrix${e}x${t}fv`,
    };
  }
  function p(e, t) {
    const a = (function (e, t) {
        ...
        for (let i = 0; i < n; i++) {
          const { name: n, type: o } = e.getActiveUniform(t, i),
            r = e.getUniformLocation(t, n);
          r && (a[n] = { type: o, location: r });
        }
        return a;
      })(e, t),
      n = {},
      i = [];
    for (let r in a) {
      const { type: e, location: t } = a[r],
        i = { type: e, location: t, v0: 0, v1: 0, v2: 0, v3: 0 };
      n[r] = i;
    }
    const o = new Set();
    return (
      ...
      {
        setUniform: function (e, t, a, r, s) {
          const l = n[e];
          l
            ? ((l.v0 = t), (l.v1 = a), (l.v2 = r), (l.v3 = s), i.push(l))
            : o.has(e) || o.add(e);
        },
        upload: function () {
          for (; i.length > 0; ) {
  ...
  function m(e) {
    let t = {};
    for (let a = 0; a < e.length; a++) t[e[a]] = a;
    return t;
  }
  function L(e, t, a, n) {
    let i =
    ...
    return (
      ...
      t === e.FRAGMENT_SHADER &&
        ...
        (i += (function (e) {
          ...
          const a = m(e);
          for (let n in a)
            t += `layout(location = ${a[n]}) out vec4 out_${n};\n`;
          return t;
        })(a.outputs)),
      a.includes &&
        (i += (function (e, t) {
          let a = "";
          for (let n of e) a += "function" == typeof n ? n(t) : n;
          return a;
        })(a.includes, n)),
      "function" == typeof a.source ? (i += a.source(n)) : (i += a.source),
      (function (e, t, a) {
        ...
        const i = a
          ...
          .map((e, t) => `${t + 1}: ${e}`)
          .join("\n");
        throw (console.log(i), e.getShaderInfoLog(n));
      })(e, t, i)
    );
  }
  function x(e, { defines: t, vertex: a }) {
    return L(e, e.VERTEX_SHADER, a, t);
  }
  function h(e, t) {
    const { fragment: a, vertex: n } = t,
      i = n instanceof WebGLShader ? n : x(e, t),
      r =
        a instanceof WebGLShader
          ? a
          : (function (e, { defines: t, fragment: a }) {
              return L(e, e.FRAGMENT_SHADER, a, t);
            })(e, t),
      s = (function (e, t, a, n, i) {
        ...
        if (
          (e.attachShader(o, t),
          e.attachShader(o, a),
          n && e.transformFeedbackVaryings(o, n, i),
          e.linkProgram(o),
          e.detachShader(o, t),
          e.detachShader(o, a),
    ...
    return __spreadProps(
      ...
      { outputLocs: a.outputs ? m(a.outputs) : {} }
    );
  }
  function v(e, t, a) {
        ...
        ? t.data
          ...
          : ((t.data = (function (e) {
              ...
              return (
                ...
                (t.height = e.height),
                a.drawImage(e, 0, 0),
                a.getImageData(0, 0, t.width, t.height).data
              );
            })(e.data.image)),
            (t.dataFormat = "byte"))
  ...
  function H(e) {
    const t = e.data,
      ...
      n = (function (e, t, a) {
        const n = new Float32Array(a * e * t);
        return {
          set(t, i, o, r) {
            n[a * (i * e + t) + o] = r;
          },
          get: (t, i, o) => n[a * (i * e + t) + o],
          width: e,
          height: t,
          channels: a,
          array: n,
    ...
    for (let o = 0; o < e.height; o++) {
      const i = Math.sin((Math.PI * (o + 0.5)) / e.height);
      for (let a = 0; a < e.width; a++) {
        const r = 3 * (o * e.width + a);
        let s = 0.2126 * t[r] + 0.7152 * t[r + 1] + 0.0722 * t[r + 2];
        (s *= i),
          n.set(a + 2, o, 0, n.get(a + 1, o, 0) + s / e.width),
          n.set(a + 1, o, 1, s);
      }
      const r = n.get(a.width - 1, o, 0);
      for (let e = 1; e < n.width; e++)
        n.set(e, o, 0, n.get(e, o, 0) / r), n.set(e, o, 1, n.get(e, o, 1) / r);
      n.set(0, o + 1, 0, n.get(0, o, 0) + r / e.height), n.set(0, o, 1, r);
    }
    const i = n.get(0, n.height - 1, 0);
    for (let o = 0; o < n.height; o++)
      n.set(0, o, 0, n.get(0, o, 0) / i), n.set(0, o, 1, n.get(0, o, 1) / i);
    return (a.data = n.array), a;
  }
  var O = {
    source: (e) =>
  ...
  function k(e, t) {
    ...
    return {
      next: function () {
        ...
        let n = a[i++];
        for (let a = 0; a < t; a++)
          (o[a] = (n % e) + Math.random()), (n = Math.floor(n / e));
        return o;
      },
      restart: r,
      strataCount: e,
  ...
  function Z(e, t) {
    ...
    return {
      next: function () {
        ...
        for (const t of a) {
          const a = t.next();
          for (const t of a) n[e++] = t;
        }
        return n;
      },
      restart: function () {
        for (const e of a) e.restart();
      },
      strataCount: e,
    };
  }
  const K =
    ...
    q =
      ...
      window.Blob &&
      new Blob([atob(K)], { type: "text/javascript;charset=utf-8" });
  function J() {
    const e = q && (window.URL || window.webkitURL).createObjectURL(q);
    try {
      return e
        ? new Worker(e)
        : new Worker("data:application/javascript;base64," + K, {
            type: "module",
          });
    } finally {
  ...
  class j {
    constructor() {
      (this.worker = new J()), (this.building = !1);
    }
    build(e) {
      if (this.building) throw new Error("BVHWorker is building");
      this.building = !0;
      const { worker: t } = this;
      return new Promise((a, n) => {
        (t.onmessage = (e) => {
          (this.building = !1), (t.onmessage = null);
          const { flattenedBvh: i, error: o } = e.data;
          o ? n(new Error(o)) : a(i);
        }),
          t.postMessage({ geometry: e });
      });
    }
  }
  function $(e) {
    const t = Math.round(Math.log2(Math.sqrt(e))),
      a = 2 ** t,
      n = Math.ceil(e / a);
    return { columnsLog: t, columns: a, rows: n, size: n * a };
  }
  function ee(e, t, a) {
    const n = $(t.length / a);
  ...
  function ae(e, t = !0) {
    ...
    return new Promise((t) => {
      const a = (function (e) {
        ...
        let i = 1;
        const o = (e, r = 1) => {
          if (((i = Math.max(r, i)), e.primitives))
        ...
        o(e);
        const r = new ArrayBuffer(4 * t.length),
  ...
  async function ne(
    ...
    const u = await (async function ({
        ...
        const m = await ae(u, r),
          L = u.index.count / 3,
          x = h(a, {
            defines: __spreadValues(
              {
                OES_texture_float_linear: l,
                BVH_COLUMNS: $(m.count).columnsLog,
                INDEX_COLUMNS: $(L).columnsLog,
                VERTEX_COLUMNS: $(u.attributes.position.count).columnsLog,
        ...
        return (
          ...
          x.setTexture(
            "positionBuffer",
            ee(a, u.getAttribute("position").array, 3)
          ),
          x.setTexture(
            "normalBuffer",
            ee(a, u.getAttribute("normal").array, 3)
          ),
          x.setTexture("uvBuffer", ee(a, u.getAttribute("uv").array, 2)),
          x.setTexture("bvhBuffer", ee(a, m.buffer, 4)),
          x
        );
      })({
        bounces: t,
      ...
      if (i) {
        ...
        if (t) {
          ...
          u.setTexture(
            ...
            u.setUniform("envMapIntensity", s);
        }
      } else {
        const e = n.data;
        e && e.isColor
          ? u.setUniform("backgroundColor", [e.r, e.g, e.b])
          : u.setUniform("backgroundColor", [0, 0, 0]);
      }
      _(l);
    }
    function x(e) {
      const { meshLights: t } = e;
      t &&
        (u.setUniform("lights.position[0]", t.position),
        u.setUniform("lights.emission[0]", t.emission),
        u.setUniform("lights.p1[0]", t.p1),
        u.setUniform("lights.p2[0]", t.p2),
        u.setUniform("lights.params[0]", t.params));
    }
    function _(e) {
      u.setUniform("enviromentVisible", Number(e));
    }
    function g() {
      u.setUniform("stratifiedSamples[0]", c.next());
    }
    return (
      m(t),
      L(a),
      ...
      (c = Z(1, p)),
      {
        ...
        draw: function () {
          u.useProgram(!1), n.draw();
        },
        outputLocs: u.outputLocs,
        textures: u.textures,
        setSize: function (e, t) {
          u.setUniform("pixelSize", 1 / e, 1 / t);
        },
        setCamera: function (e) {
          u.setUniform("camera.transform", e.matrixWorld.elements),
            u.setUniform("camera.aspect", e.aspect),
            u.setUniform(
              "camera.fov",
              0.5 / Math.tan((0.5 * Math.PI * e.fov) / 180)
            ),
            e.isLensCamera &&
              (u.setUniform("camera.aperture", e.aperture),
              u.setUniform("camera.focus", e.focus));
        },
        setGBuffers: function ({ position: e }) {
          u.setTexture("gPosition", e);
        },
        setNoise: function (t) {
          u.setTexture(
            "noiseTex",
        ...
        setJitter: function (e, t) {
          u.setUniform("jitter", e, t);
        },
        setFrameCount: function (e) {
          u.setUniform("frameCount", e);
        },
        setStrataCount: function (e) {
          e > 1 && e !== c.strataCount ? (c = Z(e, p)) : c.restart(),
            u.setUniform("strataSize", 1 / e),
            g();
        },
        nextSeed: g,
        setEnvMapIntensity: function (e) {
          u.setUniform("envMapIntensity", e);
        },
        setEnviromentVisible: _,
        updateBounces: m,
        updateEnvLight: L,
        updateMeshLight: x,
      }
  ...
  function se(e, { materialBuffer: a, mergedMesh: n }) {
    const i = h(e, { defines: a.defines, vertex: ie, fragment: oe });
  ...
  async function xe({
    ...
    enableDenoise: p,
    enableTemporalDenoise: m,
    enableSpatialDenoise: L,
    useWorker: _,
    loadingCallback: g,
  }) {
    const S = new t.PerspectiveCamera(),
      ...
      E = (function (e, t) {
        const { fullscreenQuad: a } = t,
          n = h(e, { gl: e, vertex: a.vertexShader, fragment: ce });
        return {
          draw: function (e) {
            let { light: t } = e;
            n.setTexture("inputBuffer", t), n.useProgram(), a.draw();
          },
          setSize: function (e, t) {
            n.setUniform("resolution", 1 / e, 1 / t);
          },
        };
      })(e, { fullscreenQuad: y }),
      X = (function (e, t) {
    ...
    function $(e = !0) {
      const t = Number(e && m && L);
      X.setDemodulateAlbedo(t), z.setDemodulateAlbedo(t);
    }
    (W.src =
    ...
    let ee = 0,
      te = 0;
    function ae(e, t) {
      Y.setCamera(e), b.setCamera(e), X.setPreviousCamera(t), t.copy(e);
    }
    function ie(e, t, a = !0) {
      Y.setSize(e, t), Y.setFrameCount(w);
      const n = a ? (Math.random() - 0.5) / e : 0,
        i = a ? (Math.random() - 0.5) / t : 0;
      p || Y.setJitter(n, i),
        0 === w
          ? Y.setStrataCount(1)
          : 4 === w
    ...
    function oe(e, t) {
      return (
        (function (e, t, a = 1e-4) {
          for (let n = 0; n < e.length; n++)
            if (Math.abs(e[n] - t[n]) > a) return !1;
          return !0;
        })(e.matrixWorld.elements, t.matrixWorld.elements) &&
        e.aspect === t.aspect &&
        e.fov === t.fov
      );
    }
    function re(t) {
      t.bind(), e.clear(e.COLOR_BUFFER_BIT), t.unbind();
    }
    function le(t, a, n) {
      t.bind(),
    ...
    function he() {
      if (
        (m &&
          ...
          K.unbind(),
          L || (pe(K.color[0]), (Z = K.color[0]))),
        L)
      )
        if (m) {
          pe(z.draw({ light: K.color[0], reprojectData: q.color[1] }).color[0]),
            (Z = K.color[0]);
        } else {
          pe(z.draw({ light: k.color[0], reprojectData: null }).color[0]),
            (Z = k.color[0]);
        }
    }
    function ve(t = !1) {
    ...
    return {
      ...
      fullDraw: function (e) {
        if (C) {
          if ((j(), J(), oe(e, S))) w++;
            ...
            if (u) return ae(e, S), (w = 0), void Ae();
            (w = 0), re(k);
          }
          ae(e, S),
            ie(ee, te, !0),
      ...
      setEnvMapIntensity: function (e) {
        Y.setEnvMapIntensity(e);
      },
      setEnviromentVisible: function (e) {
        Y.setEnviromentVisible(e);
      },
      setToneMapping: function (e) {
        R.setToneMapping(e);
      },
      ...
      setDenoiseColorBlendFactor: function (e) {
        X.setDenoiseColorBlendFactor(e);
      },
      setDenoiseMomentBlendFactor: function (e) {
        X.setDenoiseMomentBlendFactor(e);
      },
      ...
      setDenoisePositionFactor: function (e) {
        z.setPositionFactor(e);
      },
      getDenoiseFactors: function () {
        return Object.assign(z.getDenoiseFactors(), X.getDenoiseFactors());
      },
      setDemodulateAlbedo: $,
    };
  }
    ...
    (e.LGLTracerRenderer = class {
      constructor(e = {}) {
        (this.canvas = e.canvas || document.createElement("canvas")),
          ...
          i(this.gl, r),
          (this.optionalExtensions = i(this.gl, s)),
          (this._bounces = 2),
