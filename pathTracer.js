...
!(function (e, t) {
  ...
  async function makeRenderingPipeline({
    ...
    const tileRender = makeTileRender(e),
      ...
      E = makeFXAAPass(e, { fullscreenQuad: y }),
      X = makeReprojectPass(e, {
        fullscreenQuad: y,
        maxReprojectedSamples: 20,
      }),
      z = makeSVGFPass(e, { fullscreenQuad: y, toneMapping: r });
    let B,
      V,
      C = !1,
      w = 0,
    ...
    function setDemodulateAlbedo(e = !0) {
    ...
    function setCameras(e, t) {
      Y.setCamera(e);
      b.setCamera(e);
      X.setPreviousCamera(t);
      t.copy(e);
    }
    ...
    function ve(t = false) {
      ...
      r &&
        (0 === w && (clearBuffer(k), X.setPreviousCamera(S)),
        updateSeed(ee, te, !0),
        xe(),
        Y.bindTextures()),
        (function (t, a, n, i, o) {
      ...
      fullDraw: function (e) {
        if (C) {
          if ((j(), J(), oe(e, S))) w++;
            ...
            if (u) return setCameras(e, S), (w = 0), void Ae();
            (w = 0), clearBuffer(k);
          }
          setCameras(e, S),
            updateSeed(ee, te, !0),
